...
def test_is_file_in_folder_valid(mocker):
    ...
    assert Utils.is_file_in_folder("/folder/file.txt", "/folder") == True

def test_is_file_in_folder_file_not_exists(mocker):
    mocker.patch("os.path.isfile", return_value=False)
    mocker.patch("os.path.isdir", return_value=True)

    assert Utils.is_file_in_folder("/folder/file.txt", "/folder") == False
...
def test_is_file_in_folder_not_in_folder(mocker):
    ...
    assert Utils.is_file_in_folder("/other_folder/file.txt", "/folder") == False
