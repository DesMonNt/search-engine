...
def test_rank_documents(ranker):
    ranker.indexer.get_total_documents.return_value = 3
    ...
    ranker.indexer.get_words_in_document.side_effect = lambda doc_id: ['test', 'document'] if doc_id == 1 else [
        'sample']
